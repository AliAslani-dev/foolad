            ...
            <BRow class="g-3">
              ...
              <BCol class="col-lg-6">
                <div class="form-group">
                  ...
                  />
                  <small v-if="errors.en_address" class="text-danger">{{
                    errors.en_address
                  }}</small>
                </div>
              </BCol>
...
export default {
  setup(props, { emit }) {
    ...
    const validateForm = () => {
      errors.value = {};
      if (!address.value) errors.value.address = "وارد کردن آدرس ضروری می باشد";
      if (!en_address.value)
        errors.value.en_address = "وارد کردن آدرس به انگلیسی ضروری می باشد";
    ...
    const addLocation = () => {
      ...
      formData.append("address_en", en_address.value);

      axios
        .post(`${url}/admin/add-location`, formData, {
          headers: {
        ...
        .then(() => {
          toast.success("موقعیت با موفقیت اضافه شد!", {
            position: "top-right",
            autoClose: 1000,
        ...
        .catch((error) => {
          console.error(error);
          toast.error("مشکلی در ایجاد موقعیت به وجود آمد!", {
            position: "top-right",
            autoClose: 1000,
            onClose: () => emit("user-updated"),
          });
